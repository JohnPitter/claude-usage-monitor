...
function buildUsageContext(usage, creds) {
  ...
  return [
    "IMPORTANT: You MUST display the following Claude Code usage summary to the user at the VERY BEGINNING of your first response, BEFORE anything else. Output it exactly as shown below inside a markdown code block with no language tag:",
    "",
    "```",
    ...
    "```",
    "",
    "Display this usage card ONCE at the start of the session. Do not skip it. Do not paraphrase it. After displaying it, proceed normally with the user's request.",
  ].join("\n");
}
