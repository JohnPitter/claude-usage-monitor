...
function buildUsageCard(usage, creds) {
  ...
  const thinkingLabel = thinking ? "\uD83E\uDDE0 Thinking: ON" : "\uD83D\uDCA4 Thinking: OFF";
  ...
  if (extra?.is_enabled) {
    ...
    lines.push(`Plan: ${planLabel} | Extra: $${used} / $${limit} | ${thinkingLabel}`);
  } else {
    lines.push(`Plan: ${planLabel} | Extra: disabled | ${thinkingLabel}`);
  }
